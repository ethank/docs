...
```
User Query: "Bass like Billie Eilish - Bad Guy"
    ↓
Search curated sound database
    ↓
Find matching entry:
{
  "song": "Bad Guy",
  ...
  "element": "bass",
  "technique": "Distorted 808 with sidechain",
  "plugins": ["Moog Minimoog", "1176"],
  "tutorial_url": "..."
}
    ↓
LLM generates conversational explanation
    ↓
Return: explanation + plugin recommendations + tutorial links
```
